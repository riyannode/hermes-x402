...
_ERROR_MAPPINGS: tuple[tuple[type[BaseException], str, bool], ...] = (
    ...
    (CircleCliExitNonzeroError, "circle_cli_exit_nonzero", False),
    (CircleCliTimeoutBeforePaymentLogError, "circle_cli_timeout_before_payment_log", False),
    (CircleCliTimeoutAfterPaymentLogError, "payment_outcome_unknown", False),
    (CircleCliInvalidJsonOutputError, "circle_cli_invalid_json_output", False),
